        ...
        <div className="rs-split" style={{
          ...
          <div>
            ...
            <h2 className="rs-h2" style={{
              ...
              Defensa que se mide en cifras, no en promesas.
            </h2>
            <p style={{
              fontSize: 17,
              lineHeight: 1.6,
              ...
              Trabajamos con instituciones que no pueden permitirse interrupciones. Cada despliegue se audita, se reporta y se mejora — trimestre tras trimestre.
            </p>
            ...
            <div style={{
              ...
              <p style={{
                ...
                "Migramos nuestros 14 canales digitales a Algiz en 9 semanas. Los falsos positivos cayeron 78% y nuestro equipo SOC duerme."
              </p>
              <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
                ...
                <div>
                  <div style={{ fontSize: 14, fontWeight: 600, color: 'var(--navy)' }}>Mariana Restrepo</div>
                  <div style={{ fontSize: 12, color: 'var(--ink-3)' }}>CISO · Banco regional · Top 5 LATAM</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="rs-stats-2x2" style={{
            ...
            {[
              { n: '78%', l: 'Reducción de falsos positivos', src: 'Promedio en clientes de banca' },
              { n: '9 sem', l: 'Tiempo medio de despliegue', src: 'Desde firma hasta producción' },
              { n: '0', l: 'Brechas en producción', src: 'Desde fundación · 2018' },
              { n: '47ms', l: 'Latencia añadida (p95)', src: 'En gateway de pagos' },
            ].map((s, i) => (
              <div key={i} style={{
                background: '#fff',
                padding: 36,
                ...
                <div style={{ marginTop: 'auto' }}>
                  ...
                  <div className="mono" style={{ fontSize: 11, color: 'var(--ink-3)', letterSpacing: '0.05em' }}>→ {s.src}</div>
                </div>
              </div>
            ))}
          </div>
