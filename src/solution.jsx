...
const SOLUTIONS = {
  ...
  'atm-keygen': {
    tag: '03 — ATM Keygen',
    title: 'ATM Keygen',
    headline: 'La ceremonia de llaves de tus ATMs, sin transcripción manual.',
    intro: 'Automatiza la ceremonia de generación de llaves simétricas para flotas completas de ATMs sobre Thales payShield 10k. Imprime sobres de confidencialidad numerados, exporta la bitácora firmada — y nunca renderiza material criptográfico en pantalla.',
    accentBig: 'batch',
    accentLabel: 'Cientos de ATMs en una sola ceremonia',
    pillars: [
      { n: '01', t: 'Autenticación dual', d: 'Login con autenticación dual: ambos factores enmascarados. Los errores nunca revelan cuál falló.' },
      { n: '02', t: 'Ceremonia guiada', d: 'Datos de la institución, registro de custodios, parámetros, ATM IDs con deduplicación y generación batch con reintento de fallidos.' },
      { n: '03', t: 'Impresión sin pantalla', d: 'Criptogramas y KCV se imprimen en sobres numerados. Cada serie de sobre queda asociada al ATM ID en el CSV final.' },
      { n: '04', t: 'Cierre auditable', d: 'CSV exportado al USB con SHA-256, audit log firmado, checklist de cierre y desautorización forzada del LMK antes de apagar.' },
    ],
    compliance: ['PCI PIN', 'PCI HSM', 'ISO 9564', 'ISO 11568'],
    integrations: ['Thales payShield 10k', 'IronKey USB', 'Matriz de puntos', 'Linux hardened'],
    stats: [
      { n: '0', l: 'Llaves o KCV en pantalla' },
      { n: 'Air-gap', l: 'Equipo embedded sin red' },
      { n: 'SHA-256', l: 'CSV firmado al cierre' },
      { n: 'Batch', l: 'Cientos de ATMs por ceremonia' },
    ],
  },
